...
async def answer(callback: types.CallbackQuery):
    ...
    correct_answer_index: int = quiz_data[current_question_index]['correct_option']
    correct_answer: str = quiz_data[current_question_index]['options'][correct_answer_index]
